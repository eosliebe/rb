...
<div id="pages_source">
	...
	<div class="editarea">
		...
		<div class="subtt">
			...
			<img src="<?php echo $g['img_core']?>/_public/btn_explorer.gif" alt="파일올리기" title="파일올리기" class="hand" onclick="window.open('<?php echo $g['s']?>/?r=<?php echo $r?>&m=admin&module=filemanager&front=main&fileupload=Y&iframe=Y&pwd=./pages/images/');" />
		</div>
