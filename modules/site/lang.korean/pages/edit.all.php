...
<div id="sitebox" class="modal-body" style="padding:10px;margin:0;height:550px;overflow:auto;">
...
<div id="_modal_header" class="hidden">
    ...
    <h4 class="modal-title"><i class="fa fa-plus-circle fa-lg"></i> 사이트 등록정보</h4>
</div>
<div id="_modal_footer" class="hidden">
	<button type="button" class="btn btn-default pull-left" data-dismiss="modal" aria-hidden="true" onclick="parent.frames._ADMPNL_.location.href='http://localhost/rb2/?r=<?php echo $r?>&m=admin&module=site&front=main';">자세히</button>

	<button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">닫기</button>
	<button type="button" class="btn btn-primary" onclick="frames._modal_iframe_modal_window.siteAdd1();">수정</button>
</div>
...
{
	parent.getId('modal_window_dialog_modal_window').style.width = '750px'; //모달창 가로폭
...
<div id="pageinfo" class="modal-body" style="padding:10px;margin:0;height:550px;overflow:auto;">
...
<div id="_modal_header" class="hidden">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title"><i class="fa fa-plus-circle fa-lg"></i> 페이지 등록정보</h4>
</div>
<div id="_modal_footer" class="hidden">
	<button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">닫기</button>
	<button type="button" class="btn btn-primary" onclick="frames._modal_iframe_modal_window.siteAdd1();">수정</button>
...
<div id="catebody" class="modal-body" style="padding:10px;margin:0;height:550px;overflow:auto;">
	...
	<div id="category">
		...
		<?php $_treeOptions=array('site'=>$s,'table'=>$table['s_menu'],'dispNum'=>true,'dispHidden'=>false,'dispCheckbox'=>false,'allOpen'=>false)?>
		<?php $_treeOptions['link'] = $g['s'].'/?r='.$r.'&amp;iframe='.$iframe.'&amp;system='.$system.'&amp;type='.$type.'&amp;cat='?>
	...
	<div id="catinfo">
		...
		<table>
			...
			<tr>
				...
				<a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;iframe=<?php echo $iframe?>&amp;system=<?php echo $system?>&amp;type=<?php echo $type?>&amp;cat=<?php echo $ctarr[$i]['uid']?>&amp;code=<?php echo $subcode?>"><?php echo $ctarr[$i]['name']?></a>
			...
			<tr>
				...
				<td class="td2">
					...
					<span class="btn01"><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;iframe=<?php echo $iframe?>&amp;system=<?php echo $system?>&amp;type=<?php echo $type?>&amp;cat=<?php echo $cat?>&amp;vtype=sub&amp;makemenu=Y&amp;code=<?php echo $code?>">서브메뉴등록</a></span>
					<?php endif?>
				</td>
			</tr>
...
<div id="_modal_header" class="hidden">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title"><i class="fa fa-plus-circle fa-lg"></i> 메뉴 등록정보</h4>
</div>
<div id="_modal_footer" class="hidden">
	<button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">닫기</button>
	<button type="button" class="btn btn-primary" onclick="frames._modal_iframe_modal_window.siteAdd1();">수정</button>
