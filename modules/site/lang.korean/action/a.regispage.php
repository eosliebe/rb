...
if ($uid)
{
	...
	else getDbInsert($table['s_seo'],'rel,parent,title,keywords,description',"'2','$uid','$title','$keywords','$description'");
	...
	$QVAL = "'$pagetype','$ismain','$mobile','$id','$category','$name','$perm_g','$perm_l','$layout','$joint','$hit','$sosokmenu','$d_regis','$d_regis'";
	getDbInsert($table['s_page'],$QKEY,$QVAL);
	$lastpage = getDbCnt($table['s_page'],'max(uid)','');
	getDbInsert($table['s_seo'],'rel,parent,title,keywords,description',"'2','$lastpage','$title','$keywords','$description'");
