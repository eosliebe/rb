...
function getPageLink(lnum,p,tpage,img)
{
	if (img != '')
	{
		...
		var wp = '';
		var g_q  = p > 1 ? '<li><a href="'+getPageGo(1,wp)+'" data-toggle="tooltip" title="처음"><i class="fa fa-angle-double-left"></i></a></li>' : '<li class="disabled"><a href="#." data-toggle="tooltip" title="처음"><i class="fa fa-angle-double-left"></i></a></li>';

		if(p < lnum+1) { g_q += '<li class="disabled"><a href="#." data-toggle="tooltip" title="이전"><i class="fa fa-angle-left"></i></a></li>'; }
		else{ var pp = parseInt((p-1)/lnum)*lnum; g_q += '<li><a href="'+getPageGo(pp,wp)+'" data-toggle="tooltip" title="이전"><i class="fa fa-angle-left"></i></a></li>';}
		...
		else{var np = jn; g_q += '<li><a href="'+getPageGo(np,wp)+'" data-toggle="tooltip" title="다음"><i class="fa fa-angle-right"></i></a></li>'; }
		g_q  += tpage > p ? '<li><a href="'+getPageGo(tpage,wp)+'" data-toggle="tooltip" title="마지막 ('+tpage+' 페이지)"><i class="fa fa-angle-double-right"></i></a></li>' : '<li class="disabled"><a href="#." data-toggle="tooltip" title="마지막 ('+tpage+' 페이지)"><i class="fa fa-angle-double-right"></i></a></li>';
		document.write(g_q);
	}
}
/*페이지클릭*/
...
{
	getId(layer).className = getId(layer).className.replace('hide','');
...
function getMemberLayer(uid,e)
{
	...
	tags += '<div style="height:100%;text-align:center;" onmousedown="showMemberLayer();"><img src="'+rooturl+'/_core/images/loading/white_big.gif" alt="" style="margin-top:'+((bx.height/2)-30)+'px;" /></div>';
	ly.innerHTML = tags;
	mbrclick = true;
...
function getLayerBox(url,title,w,h,e,ar,direction)
{
	...
	if (ar==true)
	{
		if(direction=='r')tags += '<div style="width:1px;height:1px;position:absolute;"><img src="'+rooturl+'/_core/images/_public/arr_left.gif" alt="" style="position:relative;top:30px;left:-8px;" /></div>';
		if(direction=='l')tags += '<div style="width:1px;height:1px;position:absolute;"><img src="'+rooturl+'/_core/images/_public/arr_right.gif" alt="" style="position:relative;top:30px;left:'+(w)+'px;" /></div>';
		if(direction=='b')tags += '<div style="width:1px;height:1px;position:absolute;"><img src="'+rooturl+'/_core/images/_public/arr_top.gif" alt="" style="position:relative;top:-8px;left:'+parseInt(w/2)+'px;" /></div>';
		if(direction=='t')tags += '<div style="width:1px;height:1px;position:absolute;"><img src="'+rooturl+'/_core/images/_public/arr_bottom.gif" alt="" style="position:relative;top:'+(h)+'px;left:'+parseInt(w/2)+'px;" /></div>';
	}
	...
	tags += '<div style="float:right;"><img src="'+rooturl+'/_core/images/_public/ico_x_01.gif" style="padding:8px 8px 8px 8px;cursor:pointer;" alt="" title="닫기(단축키:ESC)" onclick="getLayerBoxHide();" /></div>';
...
function hubTab(mod,layer,option,obj)
{
	...
	getId(layer).innerHTML = '<div style="text-align:center;padding-top:'+(parseInt(xy.height/2)-30)+'px;"><img src="'+rooturl+'/_core/images/loading/white_big.gif" alt="" /></div>';
...
function crLayer(title,msg,flag,w,h,t)
{
	...
	if(flag=='wait') html += ' <img src="'+rooturl+'/_core/images/loading/white_small.gif" alt="" style="float:right;position:relative;left:-13px;" />';
	else html += ' <img src="'+rooturl+'/_core/images/_public/ico_x_01.gif" alt="" onclick="crLayerClose();" style="float:right;position:relative;left:-10px;cursor:pointer;" />';
	html += '</div>';
...
function modalSetting(mid,url)
{
	if (mid == '.rb-modal-x')
	{
		frames._modal_iframe_sub_.location.href = url;
	}
	else {
		var modalTag = '';
		modalTag += '<div class="modal fade" id="'+mid+'" tabindex="-1" role="dialog" aria-hidden="true"><div id="modal_window_dialog_'+mid+'" class="modal-dialog"><div class="modal-content"><div id="_modal_header_'+mid+'"></div><div id="_modal_body_'+mid+'" class="modal-body"><iframe id="_modal_iframe_'+mid+'" name="_modal_iframe_'+mid+'" src="'+url+'" width="100%" height="100%" frameborder="0" scrolling="yes"></iframe></div><div id="_modal_footer_'+mid+'"></div></div></div></div>';
		modalTag += '<div class="modal fade rb-modal-x" id="_modal_dialog_top_" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><iframe id="_modal_iframe_sub_" name="_modal_iframe_sub_" src="" width="100%" height="100%" frameborder="0" scrolling="yes"></iframe></div></div></div>';
